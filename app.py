...
def predict():
    ...
    if request.method == 'POST':
        ...
        if output<0:
            return render_template('index.html',prediction_texts="Invalid entries")
        else:
            return render_template('index.html',prediction_text="Your approximate monthly electricity bill will be {}Rs".format(output))
    else:
        return render_template('index.html')
